...
class JumbocelSpider(scrapy.Spider):
    ...
    start_urls = ['https://www.tiendasjumbo.co/buscapagina?sl=49a31962-b0e8-431b-a189-2473c95aeeeb&PS=18&cc=18&sm=0&PageNumber=1&&fq=C%3a%2f47%2f63%2f2000118%2f&O=OrderByTopSaleDESC']
    ...
    def parse(self, response):
        ...
        for i in range (30):
                npag=npag+1
                url2='&&fq=C%3a%2f47%2f63%2f2000118%2f&O=OrderByTopSaleDESC'
