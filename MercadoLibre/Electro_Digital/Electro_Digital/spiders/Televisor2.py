...
class MercadoLibreSpider(scrapy.Spider):
    name = 'MercadoLibreAudiovideo2'
    allowed_domains = ['mercadolibre.com.co']
    start_urls = ['https://electronica.mercadolibre.com.co/audio/nuevo/',
                  'https://electronica.mercadolibre.com.co/cables/nuevo/',
                  'https://electronica.mercadolibre.com.co/accesorios-audio-video/nuevo/',
                  ]
    ...
    def parse(self, response):
        ...
        for cat in categories1:
            ...
            category1_name = self.cleandata(cat.xpath('.//span[contains(@class,"filter-name")]/text()').extract_first())
            ...
            for producto in productos:
                ...
                if url.find('_JM') != -1:
                    ...
                    yield scrapy.Request(url, callback = self.parse_publicado,
                                         meta={'url': url,'category1_name': category1_name})
