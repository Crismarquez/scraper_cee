...
class MercadoLibreSpider(scrapy.Spider):
    ...
    start_urls = ['https://computacion.mercadolibre.com.co/portatiles-accesorios/nuevo/',
                  'https://computacion.mercadolibre.com.co/tablets-accesorios/nuevo/',
                  'https://computacion.mercadolibre.com.co/perifericos-pc/nuevo/',
                  'https://computacion.mercadolibre.com.co/accesorios-pc-gaming/nuevo/',
                  'https://computacion.mercadolibre.com.co/impresion/nuevo/',
                  'https://computacion.mercadolibre.com.co/pc-escritorio/nuevo/']
