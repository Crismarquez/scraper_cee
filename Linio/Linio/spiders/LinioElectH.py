...
class LinioSpiderElecH(scrapy.Spider):
    name = 'LinioElecH'
    allowed_domains = ['linio.com.co']

    start_urls = ['https://www.linio.com.co/c/electrodomesticos/linea-blanca',
                  'https://www.linio.com.co/c/electrodomesticos/pequenos-electrodomesticos',
                  'https://www.linio.com.co/c/electrodomesticos/electrodomesticos-para-tu-negocio'
                  ]
